package org.kiwiproject.elucidation.data.light;

import static org.assertj.core.api.Assertions.assertThat;

import org.kiwiproject.elucidation.data.light.config.AppConfig;
import org.kiwiproject.elucidation.data.light.resource.SmartLightResource;
...
class AppTest {
    ...
    @Test
    void testRun() {
        assertThat(APP.getEnvironment().jersey().getResourceConfig().isRegistered(SmartLightResource.class)).isTrue();
    }
